					...
					<div className='w-full'>
						...
						{!loading && currentProblem && (
							<div className='flex items-center mt-3'>
								...
								<div
									className='flex items-center cursor-pointer hover:bg-dark-fill-3 space-x-1 rounded p-[3px]  ml-4 text-lg transition-colors duration-200 text-gray-600'
									onClick={handleLike}
								>
								...
								<div
									className='cursor-pointer hover:bg-dark-fill-3  rounded p-[3px]  ml-4 text-xl transition-colors duration-200 text-green-500 text-dark-gray-6 '
									onClick={handleStar}
								>
									{starred && !updating && <AiFillStar className='text-yellow' />}
...
const getCurrentProblem = async()=>{
	...
	if (!docSnap.exists()) {
		...
		//@ts-ignore
		 ...
		 setProblemDifficultyClass(problem.difficulty === "Easy" ? "bg-olive text-olive" : problem.diificult === "Medium" ? "bg-yellow text-yellow": "bg-red text-red" );
	}
	setLoading(false)
};
 getCurrentProblem();
